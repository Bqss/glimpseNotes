...
import { useSoftDeleteNoteMutation , useArchiveNoteMutation , useToggleNotePinMutation } from "../api/services/noteApi";


const Note = ({ note, type = 0 }) => {
      ...
      <div>
        <div className="flex gap-2  justify-between">
          ...
          <div className="flex items-center ">
            ...
            <button
              className={isPinned ? "text-blue-600":null}
        ...
        <div className="flex justify-between mt-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              title="archive"
              onClick={ async () => archiveNote(note)}
            >
            ...
            <button
              ...
              title="delete"
              onClick={async () => softDeleteNote(note)}
            >
